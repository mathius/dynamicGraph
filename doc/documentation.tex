...
Dynamic Graph is a program to analyze graphs with dynamic edges that appear or disappear over time. It can find continuous 
components at given time moment, find the biggest component in a specified time interval or display simple statistics about 
nodes and edges.
Full source code and documentation is available from our public GitHub repository at \url{http://github.com/mathius/dynamicGraph}.
